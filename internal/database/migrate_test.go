...
func TestEmbeddedMigrations(t *testing.T) {
	...
	if files[3].Version != 4 || files[3].Name != "0004_monthly_releases.sql" || files[4].Version != 5 || files[4].Name != "0005_bounded_worker_scaling.sql" || files[5].Version != 6 || files[5].Name != "0006_terminal_mrf_parse_slot_release.sql" || files[6].Version != 7 || files[6].Name != "0007_nullable_plan_sponsor.sql" {
...
func TestValidateLedger(t *testing.T) {
	t.Parallel()
	files := []migrationFile{{Version: 1, Name: "0001_initial_domain.sql"}, {Version: 2, Name: "0002_feed_free_domain.sql"}, {Version: 3, Name: "0003_monthly_toc_captures.sql"}, {Version: 4, Name: "0004_monthly_releases.sql"}, {Version: 5, Name: "0005_bounded_worker_scaling.sql"}, {Version: 6, Name: "0006_terminal_mrf_parse_slot_release.sql"}, {Version: 7, Name: "0007_nullable_plan_sponsor.sql"}}
