...
func TestIntegrationMigrateCommand(t *testing.T) {
	...
	if stdout != "{\"application_version\":6,\"applied_migration_count\":6,\"river_version\":6,\"applied_river_migration_count\":6}\n" {
	...
	if stdout != "{\"application_version\":6,\"applied_migration_count\":0,\"river_version\":6,\"applied_river_migration_count\":0}\n" {
